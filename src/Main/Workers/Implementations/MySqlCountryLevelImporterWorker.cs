...
{
    public class MySqlCountryLevelImporterWorker : AbstractCountryLevelImporterWorker
    {
        #region Properties

        #endregion

        public MySqlCountryLevelImporterWorker() : base() { }

        public MySqlCountryLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
