...
{
    public class MySqlStateLevelImporterWorker : AbstractStateLevelImporterWorker
    {
        #region Properties

        #endregion

        public MySqlStateLevelImporterWorker() : base() { }

        public MySqlStateLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
