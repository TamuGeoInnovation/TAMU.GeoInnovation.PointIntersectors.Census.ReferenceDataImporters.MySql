...
{
    public class MySqlCensusTractLevelIndexUpdaterImporterWorker : AbstractCensusTractLevelIndexUpdaterImporterWorker
    {
        #region Properties

        #endregion

        public MySqlCensusTractLevelIndexUpdaterImporterWorker() : base() { }

        public MySqlCensusTractLevelIndexUpdaterImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager) : base(traceSource, backgroundWorker, outputDataQueryManager, schemaManager) { }
