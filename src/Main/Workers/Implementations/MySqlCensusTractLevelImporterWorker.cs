...
namespace TAMU.GeoInnovation.PointIntersectors.Census.ReferenceDataImporters.MySql
{
    public class MySqlCensusTractLevelImporterWorker : AbstractCensusTractLevelImporterWorker
    {
        #region Properties

        #endregion

        public MySqlCensusTractLevelImporterWorker() : base() { }

        public MySqlCensusTractLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
