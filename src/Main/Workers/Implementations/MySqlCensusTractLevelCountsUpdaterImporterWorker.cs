...
{
    public class MySqlCensusTractLevelCountsUpdaterImporterWorker : AbstractCensusTractLevelCountsUpdaterImporterWorker
    {
        #region Properties

        #endregion

        public MySqlCensusTractLevelCountsUpdaterImporterWorker() : base() { }

        public MySqlCensusTractLevelCountsUpdaterImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager) : base(traceSource, backgroundWorker, outputDataQueryManager, schemaManager) { }
